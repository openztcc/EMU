...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD ul_reason_for_call, LPVOID lpReserved) {
	...
	case DLL_PROCESS_ATTACH:
		...
		EmuMain::shared_instance().emu_run.LoadScripts("emu_run");
		EmuMain::shared_instance().emu_gawk.LoadScripts("emu_gawk");
		EmuMain::shared_instance().emu_gawk.InitGlobalState();
